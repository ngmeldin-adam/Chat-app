...
const Profile = () => {
    ...
    const [selectedImg , seSelectedImg]= useState(null);
        ...
        justify-center">
            ...
            border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg">
                <form onSubmit={handleSubmit} action="" className="flex flex-col gap-5 p-10 flex-1">
                    ...
                    <label htmlFor="avatar" className="flex items-center gap-3 cursor-poiner">
                        <input onChange={(e)=> seSelectedImg(e.target.files[0])} type="file" id="avatar" accept=".png, .jpg, .jpeg" hidden />
                    ...
                    <input type="text" onChange={(e)=>setName(e.target.value)} value={name} required placeholder="Your name"
                     ...
                     p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500"
